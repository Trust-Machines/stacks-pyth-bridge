...
(define-private (update-and-read-stx-price-from-pyth (stx-price-feed (buff 2048))) 
  (let ((updated-prices-ids (unwrap! 
          (contract-call? 'ST2T5JKWWP3FYYX4YRK8GK5BG2YCNGEAEY1JKX06E.pyth-oracle-v4 verify-and-update-price-feeds 
            stx-price-feed
            {
              pyth-storage-contract: 'ST2T5JKWWP3FYYX4YRK8GK5BG2YCNGEAEY1JKX06E.pyth-storage-v4,
...
(define-private (read-price-from-pyth (price-id (buff 32)))
    (let ((feed (unwrap! (contract-call? 'ST2T5JKWWP3FYYX4YRK8GK5BG2YCNGEAEY1JKX06E.pyth-oracle-v4 read-price-feed price-id 'ST2T5JKWWP3FYYX4YRK8GK5BG2YCNGEAEY1JKX06E.pyth-storage-v4) (err u0)))
